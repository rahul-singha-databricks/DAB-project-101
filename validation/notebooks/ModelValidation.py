...
#
# It runs as part of CD and by an automated model training job -> validation -> deployment job defined under ``dab_project_101/resources/model-workflow-resource.yml``
#
#
# Parameters:
#
...
# * custom_metrics_loader_function          - Specifies the name of the function in dab_project_101/validation/validation.py that returns custom metrics.
# * validation_thresholds_loader_function   - Specifies the name of the function in dab_project_101/validation/validation.py that returns model validation thresholds.
#
...
dbutils.widgets.text(
    "experiment_name",
    "/dev-dab_project_101-experiment",
    "Experiment Name",
)
...
dbutils.widgets.text("model_name", "dev.dab_project_101.dab_project_101-model", "Full (Three-Level) Model Name")

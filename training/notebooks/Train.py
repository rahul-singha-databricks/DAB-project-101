...
# ``dab_project_101/resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-dab_project_101-experiment",
    label="MLflow experiment name",
)
# Unity Catalog registered model name to use for the trained model.
dbutils.widgets.text(
    "model_name", "dev.dab_project_101.dab_project_101-model", label="Full (Three-Level) Model Name"
)
